...
//		config.filebrowserBrowseUrl = config.ckfinderPath+'/ckfinder.html?type=files&start=files:'+config.ckfinderUploadPath;
		config.filebrowserBrowseUrl = "/a/resource/resInfo";  //resource/resInfo
		config.filebrowserImageBrowseUrl = "/a/resource/resInfo?selectEnable=true";
		config.filebrowserFlashBrowseUrl = "/oms/a/resource/resInfo/selectList";
		config.filebrowserUploadUrl =  "/a/resource/resInfo";
		config.filebrowserImageUploadUrl = "/a/resource/resInfo/imageUpload";
		// config.filebrowserImageUploadUrl = "/a/resource/imageUpload";
		// config.filebrowserImageUploadUrl = "https://help.aliyun.com/document_detail/oss/user_guide/oss_concept/endpoint.html?spm=5176.docoss/user_guide/endpoint_region";
