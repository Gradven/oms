 ...
 */
package com.channelsharing.hongqu.oms.modules.sys.web;
...
import com.channelsharing.hongqu.oms.common.beanvalidator.BeanValidators;
...
import com.channelsharing.hongqu.oms.common.utils.excel.ImportExcel;
...
import com.channelsharing.hongqu.oms.common.utils.excel.ExportExcel;
...
public class UserController extends BaseController {
	...
	public String save(User user, HttpServletRequest request, Model model, RedirectAttributes redirectAttributes) {
		...
		user.setCompany(new Office(Long.valueOf(request.getParameter("company.id"))));
		user.setOffice(new Office(Long.valueOf(request.getParameter("office.id"))));
		// 如果新密码为空，则不更换密码
