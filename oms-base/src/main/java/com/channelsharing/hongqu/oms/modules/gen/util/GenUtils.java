 ...
 */
package com.channelsharing.hongqu.oms.modules.gen.util;
...
import com.channelsharing.hongqu.oms.common.mapper.JaxbMapper;
import com.channelsharing.hongqu.oms.common.utils.FileUtils;
...
import com.channelsharing.hongqu.oms.modules.sys.entity.Office;
...
import com.channelsharing.hongqu.oms.common.utils.FreeMarkers;
...
import com.channelsharing.hongqu.oms.modules.gen.entity.GenCategory;
...
public class GenUtils {
	...
	public static void initColumnField(GenTable genTable){
		for (GenTableColumn column : genTable.getColumnList()){
			...
			}else if ( StringUtils.startsWithIgnoreCase(column.getJdbcType(), "INT") || StringUtils.startsWithIgnoreCase(column.getJdbcType(), "TINYINT") ){
			...
			if (StringUtils.equalsIgnoreCase(column.getName(), "name")
					...
					|| StringUtils.equalsIgnoreCase(column.getName(), "remark")
			...
			// 备注、内容
			else if (StringUtils.equalsIgnoreCase(column.getName(), "remark")
...
//		}
	...
	public static String generateToFile(GenTemplate tpl, Map<String, Object> model, boolean isReplaceFile){
		...
		String projectPath = (String) model.get("projectPath");  //原来从配置文件中获取，改为从表中获取
		String tplFilePath = FreeMarkers.renderString(tpl.getFilePath() + "/", model);
		String replaceTplFilePath = StringUtils.replaceEach(tplFilePath, new String[]{"//", "/", "."}, new String[]{File.separator, File.separator, File.separator});
		String tplFileName = FreeMarkers.renderString(tpl.getFileName(), model);
		fileName = projectPath + File.separator+ replaceTplFilePath + tplFileName;
