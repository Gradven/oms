	...
	<div id="main">
		<div id="header" class="navbar navbar-fixed-top">
			<div class="navbar-inner">
				...
				<ul id="userControl" class="nav pull-right">
					<li><a href=${fns:getConfig('web.url')} target="_blank" title="访问网站主页"><i class="icon-home"></i></a></li>
	    ...
	    <div class="container-fluid">
		    ...
		    <div id="footer" class="row-fluid">
	            Copyright &copy; ${fns:getConfig('copyrightYear')} ${fns:getConfig('productName')} - Powered By <a href="#" target="_blank">通路共享科技</a> ${fns:getConfig('version')}
			</div>
		</div>
	</div>
	<script type="text/javascript">
