...
<body>
	...
	<form:form id="inputForm" modelAttribute="genScheme" action="${ctx}/gen/genScheme/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			<label class="control-label">生成文件工程路径:</label>
			<div class="controls">
				<form:input path="projectPath" htmlEscape="false" maxlength="500" class="required input-xlarge"/>
				<span class="help-inline">示例：d:/workspace/oms/oms-read, /Users/xxxx/Documents/workspace/common/oms/oms-read</span>
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				...
				<span class="help-inline">建议模块包：com.channelsharing.hongqu.oms.modules</span>
			</div>
		</div>
		<div class="control-group">
